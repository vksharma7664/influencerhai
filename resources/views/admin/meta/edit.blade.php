        ...
        <div class="portlet portlet-default">
            ...
            <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                    <form role="form" method="post"  action="{{route('meta.update', $result['0']->id)}}"enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="route" class="form-control" placeholder="Enter route"  value="{{$result['0']->route}}" disabled>
                            </div>
                            <div class="form-group col-md-8">
                                <label for="exampleInputEmail1">Title </label>
                                @error('title')<b class="text-center text-red">{{$message}}</b>@enderror
                                <input type="text" name="title" class="form-control" placeholder="Enter title"  value="{{$result['0']->title}}">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="desc" name="desc" placeholder="Enter Short Description" >{{$result['0']->desc}}</textarea>
