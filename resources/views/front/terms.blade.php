                ...
                <div class="col-md-12">
                    <div class="h2-we-make-heading heading-content pb-50 get-bottom animate">
                        <div class="section-title animate">
                            <h2 class="pb-10">Terms & Conditions</h2>
                        </div>
                    </div>
                </div>
                        <hr>
